        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Classification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    InstructorDescription = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalRanking = table.Column<int>(type: "int", nullable: true),
                    UniversityImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PointName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonsLearned_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentsRequired", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentsRequired_Universities_UniversityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(MAX)", nullable: false),
                    StudentsNumber = table.Column<int>(type: "int", nullable: true),
                    DurationOfStudy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProgramsNumber = table.Column<int>(type: "int", nullable: true),
                    Rank = table.Column<int>(type: "int", nullable: true),
                    Specializations = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    RequireAcceptanceTests = table.Column<bool>(type: "bit", nullable: false),
                    UniversityId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HousingOptions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobOpportunities_Faculties_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    YearsNumber = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(MAX)", nullable: false),
                    AcademicQualification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    FacultyId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyPlanYears", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudyPlanYears_Faculties_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyPlanMedia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudyPlanMedia_StudyPlanYears_StudyPlanYearId",
                        column: x => x.StudyPlanYearId,
                        principalTable: "StudyPlanYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "StudyPlanSections",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyPlanSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudyPlanSections_StudyPlanYears_StudyPlanYearId",
                        column: x => x.StudyPlanYearId,
                        principalTable: "StudyPlanYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudyPlanYearId = table.Column<int>(type: "int", nullable: true),
                    StudyPlanSectionId = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicMaterials_StudyPlanSections_StudyPlanSectionId",
                        column: x => x.StudyPlanSectionId,
                        principalTable: "StudyPlanSections",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AcademicMaterials_StudyPlanYears_StudyPlanYearId",
                        column: x => x.StudyPlanYearId,
                        principalTable: "StudyPlanYears",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicMaterials_StudyPlanSectionId",
                table: "AcademicMaterials",
                column: "StudyPlanSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicMaterials_StudyPlanYearId",
                table: "AcademicMaterials",
                column: "StudyPlanYearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentsRequired_UniversityId",
                table: "DocumentsRequired",
                column: "UniversityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HousingOptions_UniversityId",
                table: "HousingOptions",
                column: "UniversityId");

            migrationBuilder.CreateIndex(
                name: "IX_JobOpportunities_FacultyId",
                table: "JobOpportunities",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonsLearned_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourses_EnrollmentStatus",
                table: "StudentCourses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanMedia_StudyPlanYearId",
                table: "StudyPlanMedia",
                column: "StudyPlanYearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanYears_FacultyId_YearName",
                table: "StudyPlanYears",
                columns: new[] { "FacultyId", "YearName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanYears_FacultyId_YearNumber",
                table: "StudyPlanYears",
                columns: new[] { "FacultyId", "YearNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanYears_Type",
                table: "StudyPlanYears",
                column: "Type");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Universities_IsTrending",
                table: "Universities",
                column: "IsTrending");
